...
typedef enum _GstQuarkId
{
  ...
  GST_QUARK_PUSH_BUFFER_PRE = 170,
  GST_QUARK_PUSH_BUFFER_POST = 171,
  GST_QUARK_PUSH_BUFFER_LIST_PRE = 172,
  GST_QUARK_PUSH_BUFFER_LIST_POST = 173,
  GST_QUARK_DOT_TS = 174,
  GST_QUARK_RETURN = 175,
  GST_QUARK_PAD = 176,
  GST_QUARK_BUFFER = 177,
  GST_QUARK_LIST = 178,
  GST_QUARK_MAX = 179
} GstQuarkId;
